package jp.co.hottolink.buzzfund.calendar;
...
public class KtHoliday{
  ...
  public static String getHolidayName( Date prmDate ) throws ParseException
  {
      SimpleDateFormat f = new SimpleDateFormat ( "yyyy/MM/dd" );
      return getHolidayName( f.format( prmDate ) );
  }
}
